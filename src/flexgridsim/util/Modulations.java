...
public class Modulations {
	...
	public static final int distance[] = {10000000,2000,1000,500,250,125};
	 ...
	 * @return the modulation by distance
	 */
	public static int getModulationProtectionByDistance(int givendistance){
		givendistance=givendistance/2;
		if(givendistance==-1)
			return -1;
		if (givendistance <= distance[5]){
			return 5;
	...
	public static int bitsPerSymbol(int modulationLevel) {
		switch(modulationLevel) {
		case 0:
			return 1;
		case 1:
